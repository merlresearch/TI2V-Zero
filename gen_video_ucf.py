...
# keep generating videos on UCF dataset for evaluation
import os
import sys
...
from dataset.datasets_ucf import UCF_gen
...
root_dir = "/data/hfn5052/img2vid-zero/cvpr24/show/UCF"
# set path to UCF101 dataset
...
def main():
    ...
    testloader = data.DataLoader(
        UCF_gen(data_dir=data_dir, image_size=IMG_SIZE, num_frames=NUM_FRAMES),
